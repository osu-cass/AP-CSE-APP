...
import { FilterItemList, FilterItemListProps } from '.';
import {} from '../FilterItem';

// cSpell:disable
const filterItemMockProps: FilterItemListProps = {
  allItems: [
    {
      subject: 'Lorem',
      grade: 'Ipsum',
...
storiesOf('FilterItemList component', module)
  ...
  .add('FilterItemList', () => <FilterItemList {...filterItemMockProps} />);

...
/* tslint:disable */
const ELAG3C2T4Mock: IClaim = {
  'subject': 'English Language Arts',
  'title': 'English Language Arts Specification: Grade 3 Claim 2',
  'grades': ['3'],
  'claimNumber': 'C2',
  'target': [{
    'interactionType': 'PT',
    ...
    'stem': [{
      ...
      'stemDesc': '**Lead-in:** No lead-in\r\n\r\n**Stimulus:** No additional stimulus \r\n\r\n**Stems:**\r\n\r\n-   Click on the boxes to match each source with the [idea/opinion] that it supports. Some [ideas/opinions] may have more than one source selected.\r\n\r\n   **Example of Formatting:**\r\n\r\n|   | Source #1: [title] |  Source #2: [title] |\r\n|---|--------|--------|\r\n| [idea/opinion] _____________   |  |   |\r\n| [idea/opinion] _____________   |  |   |\r\n $~$ \r\n\r\n \r\n-   Look at the [ideas/opinions] in the table. Decide if the information in Source \\#1, Source \\#2, both sources, or neither source supports each [idea/opinion]. Click on the box to match the source that supports each [idea/opinion]. There will be only one box selected for each [idea/opinion].\r\n\r\n**Example of Formatting:**\r\n\r\n\r\n\r\n|  |  Source #1: [title] |  Source #2: [title] |  Both  |  Neither  | \r\n|------------------|---|---|---|---|\r\n| [idea/opinion] |   |   |   |   |  \r\n| [idea/opinion] |   |   |   |   |  \r\n| [idea/opinion] |   |   |   |   |  \r\n$~$\r\n\r\n**Clarifications:** Matching tables should have no more than three correct answers at this grade level. If there are too many defensible options (check every possibility) do not use this item type, use multiple-choice.',
      'shortStem': 'Appropriate Stems'
    }, { 'stemDesc': 'NA', 'shortStem': 'Appropriate Stems' }],
    'standards': [{
    ...
    }, { 'stdCode': 'E.G3.C2WO.T6a.W.3.1b', 'stdDesc': 'Provide reasons that support the opinion.' }],
    'evidence': [{
      'evTitle': 'Evidence 1',
    ...
    'description': 'Distinguish relevant/irrelevant information.',
    ...
    'DOK': [{
      'dokCode': 'W-DOK4',
      'dokDesc': 'Higher-level thinking is central to Level 4. The standard at this level is a multi- paragraph composition that demonstrates synthesis and analysis of complex ideas or themes. There is evidence of a deep awareness of purpose and audience. For example, informational papers include hypotheses and supporting evidence. Students are expected to create compositions that demonstrate a distinct voice and that stimulate the reader or listener to consider new perspectives on the addressed ideas and themes.',
      'dokShort': 'Level 4: Extended Thinking'
    }]
  }],
  'shortCode': 'E.G3.C2',
  'description': 'Students can produce effective writing for a range of purposes and audiences.',
  'domain': [{ 'title': 'Narrative' }]
};
export default ELAG3C2T4Mock;
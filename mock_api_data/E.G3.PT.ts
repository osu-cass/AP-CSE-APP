...
export const ELAG3TargetMock = {
    ...
    "target": [
        {
            "title": "English Language Arts Performance Task Specification: Grade 3 Informational Writing",
            "shortCode": "E.G3.C4R.T4",
            "description": "Cite evidence to support opinions and ideas.",
            "standards": [
                {
            ...
            "evidence": [
                "The student will locate information from multiple sources to support a central idea or key detail related to research.",
                "The student will interpret information from multiple sources to support a given purpose related to research tasks.",
                "The student will interpret information from a visual source to support a given purpose related to research tasks.",
                "The student will analyze digital and print sources in order to locate relevant information to support research.",
                "The student will analyze illustrations in order to locate relevant information to support research.",
                "The student will select evidence to support opinions or ideas based on evidence collected.",
                "The student will write full informational texts on a topic using a complete writing process attending to purpose and audience: organize ideas by stating a focus (main idea); include text structures and appropriate transitional strategies for coherence; include elaboration and supporting evidence from sources and an appropriate conclusion."
            ],
            "vocab": "string",
            ...
            "rubrics": [
                ...
                "Rubric 1b",
                "Response is an adequate evidence-based explanation of &#60topic&#62  supported by two details from different sources (one from each source). Student cites the source for each detail.",
                "**Scoring Note:** Score point 1 encompasses partially correct responses.\r\n\r\nResponse is a limited/partial evidence-based explanation of &#60topic&#62  supported by two vague or loosely related details from different sources (one from each source). Student cites the source for each detail.\r\n**OR**\r\nResponse is an adequate evidence-based explanation of &#60topic&#62  supported by two details from one source. Student cites the source for each detail.\r\n**OR**\r\nResponse is an adequate evidence-based explanation of &#60topic&#62  supported by one detail from one source. Student cites the source for the detail.\r\n**OR**\r\nResponse is an adequate evidence-based explanation of &#60topic&#62  supported by two details from different sources (one from each source). Student does not cite the source for each detail.",
                "Response is an explanation that is insufficient, incorrect or irrelevant.",
                "Scoring Rules",
                "Rubric 3a",
                "Response is an adequate evidence-based explanation of how an illustration in Source #1 would be helpful if it were added to Source #2. The explanation is supported by two [details/examples] from Source #2.",
                "**Scoring Note:** Score point 1 encompasses partially correct responses.\r\n\r\nResponse is a limited/partial evidence-based explanation of how an illustration in Source #1 would be helpful if it were added to Source #2. The explanation is supported by two vague or loosely related [details/examples] from Source #2.  \r\n**OR**\r\nResponse is an adequate evidence-based explanation of how an illustration in Source #1 would be helpful if it were added to Source #2. The explanation is supported by one [detail/example] from Source #2.",
                "Response is an explanation that is insufficient, incorrect or irrelevant.",
                "Rubric 3b",
                ...
                "Scoring Rules",
                "Rubric 5a",
                "Response is an identification of which source has more helpful information in understanding &#60idea/process&#62 and an adequate evidence-based explanation of why it has more helpful information in understanding  &#60idea/process&#62, supported by two [details/examples] from the identified source.",
                "**Scoring Note:** Score point 1 encompasses partially correct responses.\r\n\r\nResponse is an identification of which source has more  helpful information in understanding &#60idea/process&#62 and a limited or partial evidence-based explanation of why it has more helpful information in understanding  &#60idea/process&#62, supported by two vague or loosely related [details/examples] from the identified source.  \r\n**OR**\r\nResponse is an identification of which source has more helpful information in understanding &#60idea/process&#62 and an adequate evidence-based explanation of why it has more helpful information in understanding  &#60idea/process&#62, supported by one [detail/example] from the identified source.",
                "Response is an explanation that is insufficient, incorrect or irrelevant.  Just identifying the source is insufficient.",
                "Rubric 5b",
                "Response is an identification of which source has more useful information about &#60topic&#62 and an adequate evidence-based explanation of why it has more useful information about  &#60topic&#62, supported by two [details/examples] from the identified source.",
                "**Scoring Note:** Score point 1 encompasses partially correct responses.\r\n\r\nResponse is an identification of which source has more  useful information about &#60topic&#62 and a limited or partial evidence-based explanation of why it has more useful information about &#60topic&#62, supported by two vague or loosely related [details/examples] from the identified source.  \r\n**OR**\r\nResponse is an identification of which source has more useful information about &#60topic&#62 and an adequate evidence-based explanation of why it has more useful information in about  &#60topic&#62, supported by one [detail/example] from the identified source.",
                "Response is an explanation that is insufficient, incorrect or irrelevant. Just identifying the source is insufficient.",
                "Scoring Rules",
                "Rubric 7",
                "Response is an identification of what information from the illustration in Source #1 is the most useful information in understanding  &#60idea/process&#62 in Source #2 and an adequate evidence-based explanation of why it is the most useful supported by two [details/examples] from Source #2.",
                "**Scoring Note:** Score point 1 encompasses partially correct responses.\r\n\r\nResponse is an identification of what information from the illustration in Source #1 is the most useful information in understanding &#60idea/process&#62 in Source #2 and a limited/partial evidence-based explanation of why it is the most useful supported by two vague or loosely related [details/examples] from Source #2.  \r\n**OR**\r\nResponse is an identification of what information from the illustration in Source #1 is the most useful information in understanding &#60idea/process&#62 in Source #2 and an adequate evidence-based explanation of why it is the most useful supported by one [detail/example] from Source #2.  \r\n**OR**\r\nResponse is an identification of what information from the illustration in Source #1 is the most useful information in understanding &#60idea/process&#62 in Source #2 and an adequate evidence-based explanation of why it is the most useful supported by two [details/examples] from Source #1 or one [detail/example] from Source #1 and one [detail/example] from Source #2.",
                "Response is an explanation that is insufficient, incorrect or irrelevant.  Just identifying the most useful information is insufficient.",
                "Scoring Rules",
                "Rubric 9a",
                ...
                "Response is an explanation that is insufficient, incorrect or irrelevant.",
                "Rubric 9b",
                "Response is an adequate evidence-based explanation of what would happen if &#60possible effect from a cause discussed in sources&#62 supported by two [details/examples], one detail from Source #1 and one [detail/example] from Source #2. Student cites the source for each [detail/example].",
                ...
                "Scoring Rules",
                "Rubric 11 - Organization/Purpose",
                ...
                "NA",
                "Rubric 11 - Evidence/Elaboration",
